...
_STATUS_LABELS: dict[tuple[type[Enum], str], str] = (
    {
        ...
        (RoomOccupancyStatus, "unknown"): "房态待确认",
        (RoomOccupancyStatus, "vacant"): "近期空置",
        (RoomOccupancyStatus, "arriving_today"): "今日入住",
        (RoomOccupancyStatus, "occupied"): "在住",
        (RoomOccupancyStatus, "departing_today"): "今日退房",
